...
var polyfills = __webpack_require__(387)
var legacy = __webpack_require__(969)
...
const webshot = __webpack_require__(551);
...
(async () => {
    ...
    if (core.getInput("plain-text"))
        customTheme = core.getInput("theme");

    const url = `https://og-image.now.sh/**${boldText}**%20${plainText}?theme=${theme}&md=1&fontSize=100px&images=https%3A%2F%2Fassets.vercel.com%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fhyper-color-logo.svg`;
...
var url = __webpack_require__(835)
  , fs = __webpack_require__(83)
  , tmp = __webpack_require__(608)
  , stream = __webpack_require__(413)
  , crossSpawn = __webpack_require__(775)
  , optUtils = __webpack_require__(528)
  , phantomScript = __webpack_require__.ab + "webshot.phantom.js"
...
module.exports = function() {
  ...
  */
  ...
  try {
    defaults.phantomPath = __webpack_require__(580).path;
  } catch (ex) {}
...
function spawnPhantom(site, path, streaming, options, cb) {
  ...
  var phantomArgs = [__webpack_require__.ab + "webshot.phantom.js", JSON.stringify(filteredOptions)];
...
var Promise = __webpack_require__(564).Promise
 ...
 */
try {
  var location = __webpack_require__(184)
...
const osTmpDir = __webpack_require__(258);
...
var LRU = __webpack_require__(579);
